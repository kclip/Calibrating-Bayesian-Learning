...
from Net.resnet_large import resnet50 as bayes50
import dill
...
models = {
    ...
    'wideresnet402': bayes_wideresnet_40_2,
    'bayes50': bayes50
}
...
def parseArgs():
    ...
    model = 'wideresnet402'
    epoch = 100
    first_milestone = 30 #Milestone for change in lr
    second_milestone = 60 #Milestone for change in lr
    third_milestone = 90
    ...
    parser.add_argument("--kl", type=float, default=0.00035)
    ...
    parser.add_argument("--third-milestone", type=int, default=third_milestone, dest="third_milestone", help="Third milestone to change lr")
...
if __name__ == "__main__":
    ...
    if ('wideresnet402' in args.model):
        net = models[args.model]()
    elif ('bayesresnet' in args.model):
        net = models[args.model]()
    elif ('bayes50' in args.model):
    ...
    scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[args.first_milestone, args.second_milestone, args.third_milestone], gamma=0.2)
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        scheduler.step()
        gamma = args.gamma
        train_single_epoch(args.kl, epoch, net, train_loader, optimizer, device, loss_function=args.loss_function, gamma=gamma, lamda=args.lamda, loss_mean=args.loss_mean)

    torch.save(net, './models/bnn-gamma-{}.pt'.format(args.lamda))