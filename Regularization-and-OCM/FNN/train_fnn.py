...
from Net.resnet import resnet50, resnet110, resnet18
...
if __name__ == "__main__":
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        train_single_epoch(epoch, net, train_loader, optimizer, device, loss_function=args.loss_function, gamma=gamma, lamda=args.lamda, loss_mean=args.loss_mean)

    torch.save(net, './new_models/fnn.pt')
